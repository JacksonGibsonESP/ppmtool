package udemy.learning.ppmtool.exception;
...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler
    public final ResponseEntity<UsernameAlreadyExistsResponse> usernameAlreadyExistsException(UsernameAlreadyExistsException ex) {
